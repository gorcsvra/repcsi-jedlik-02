...
<li>3.        A felhősödési arányszám 1 és 100 közötti szám lehet. Ha felhasználó nem ebbe az intervallumba eső számot ír, figyelmeztessük.</li>
  ...
  <form method="post" @submit.prevent="feltetel">
    ...
    <input type="number" min="1" max="100" id="felhosodes" v-model="felhosodes" required />
  ...
  methods: {
    ...
    urlapellenorzes() {
      ...
      if (
        ...
        (this.szelIrany > 54 & this.szelIrany < 126))
         { this.nemAjanlott = true; hiba = true; return this.nemAjanlott="Nem ajánlott a felszállá!s"; }
